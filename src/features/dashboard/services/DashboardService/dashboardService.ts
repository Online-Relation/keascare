...
import { getVisFilter, getParagraf43Filter, privatFilterTpOr, privatFilterCvrOr, paragraf43InkluderOr, paragraf43EkskluderOr, KOMMUNALE_NØGLEORD } from '@/lib/config/GlobalFilter';
