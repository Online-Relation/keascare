...
type DbRapport = {
  ...
  tp_godkendelsesstatus: string | null;
...
function mapTilBostedDetail(r: DbRapport): BostedDetail {
  return {
    ...
    tpGodkendelsesstatus: r.tp_godkendelsesstatus ?? null,
    ...
    sorKode: r.sor_kode ?? null,
    losMedlem: r.los_medlem ?? null,
  };
}
